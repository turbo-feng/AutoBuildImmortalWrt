...
# PACKAGES="$PACKAGES luci-i18n-diskman-zh-cn"  磁盘管理和文件管理器多余
...
# PACKAGES="$PACKAGES luci-i18n-samba4-zh-cn"  会多出NAS管理菜单
# PACKAGES="$PACKAGES luci-i18n-dufs-zh-cn" 静态文件服务器dufs(推荐) 配合samba实现远程轻nas管理
